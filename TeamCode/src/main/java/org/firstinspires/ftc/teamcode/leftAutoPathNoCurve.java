...
@Autonomous
public class leftAutoPathNoCurve extends OpMode {

    private Follower follower;
    private Timer pathTimer, opModeTimer;
    private shootMotorInit shootMotor;  // Add shoot motor
    ...
    private final Pose startPose =
            new Pose(20.292682926829265, 122.73170731707316, Math.toRadians(90));

    private final Pose shootPose =
            new Pose(29.853658536585364, 112.78048780487804, Math.toRadians(144));

    // Collect 1
    private final Pose collect1YPose =
            new Pose(50.146341463414636, 83.70731707317073, Math.toRadians(180));

    private final Pose collect1XPose =
            new Pose(12.682926829268292, 83.70731707317073, Math.toRadians(180));

    // Collect 2
    private final Pose collect2YPose =
            new Pose(56.58536585365853, 60.29268292682927, Math.toRadians(180));

    private final Pose collect2XPose =
            new Pose(12.878048780487806, 59.90243902439026, Math.toRadians(144));

    // Collect 3
    private final Pose collect3YPose =
            new Pose(62.048780487804876, 35.70731707317073, Math.toRadians(180));

    private final Pose collect3XPose =
            new Pose(14.048780487804878, 35.90243902439025, Math.toRadians(180));
